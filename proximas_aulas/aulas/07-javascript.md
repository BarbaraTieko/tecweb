...
!!! example
    ...
    ```javascript
    let promesa = fetch("https://cat-fact.herokuapp.com/facts/random");
    console.log(promesa);
    ...
    console.log(objetoDaResposta); // Agora sim!
    ```
...
```javascript
let objetoDaResposta = await fetch("https://cat-fact.herokuapp.com/facts/random").then(
  ((resultado) => resultado.json()))
console.log(objetoDaResposta);
```
...
!!! example
    ...
    fetch("https://cat-fact.herokuapp.com/facts/random").then(
      ...
      ((objetoDaResposta) => console.log(objetoDaResposta)))
