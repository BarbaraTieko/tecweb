...
É comum utilizarmos nomes como `env` ou `.env` para o `NOME_DA_PASTA_DO_VENV`. Para Tecnologias Web, vamos padronizar o uso do nome `env`. Assim, o comando seria: `python3 -m venv env`
