...
Lembra que em Desenvolvimento Colaborativo Ágil nós aprendemos sobre os diferentes tipos de teste de software? Vamos começar definindo uma história de usuário. O objetivo não é fazer uma revisão de Co-Design de Aplicativos, então vamos assumir que temos uma persona pronta e o seu nome é Fábio:

!!!danger "Lista de filmes"
    **SENDO** o Fábio

    **POSSO** digitar o endereço do Simpliflix no navegador e visualizar a lista de filmes disponíveis

    **PARA** me distrair pensando em qual filme eu assistiria se tivesse tempo
...
```python
--8<-- "01-simpliflix/codigo/passo1.py"
```
...
--8<-- "01-simpliflix/codigo/passo2.py"
```
...
--8<-- "01-simpliflix/codigo/passo3.py"
```
