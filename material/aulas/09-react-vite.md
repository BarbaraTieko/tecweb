...
2. Crie um novo projeto React com o comando :
    ```
    npm create vite@latest
    ```

3. Em seguida, serão realizadas algumas perguntas para que o seu projeto seja criado.

    - Project name: Escolha um nome para o seu projeto.
  ...
  Caso dê algum problema, atualize a versão do node para a versão mais recente.
