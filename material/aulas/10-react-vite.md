...
**Github Classroom**
<!-- 
Crie o repositório do Github Classroom para fazer o envio deste handout. [Link para o Github Classroom](https://classroom.github.com/a/yXjdZpUb){:target="_blank"}. -->
...
4. Rode os comando abaixo para entrar na pasta do projeto, instalar as dependências e rodar o projeto:
    ```bash
    cd notes-frontend
    npm install
    npm run dev
