...
Nossa tabela foi criada, mas ainda não possui nenhum dado. Para inserir dados na tabela utilizamos o comando SQL `#!sql INSERT INTO NOME_DA_TABELA NOMES_DAS_COLUNAS VALUES VALORES_DAS_COLUNAS`. Por exemplo, na tabela `dados_pessoais`, que usamos de exemplo na parte 2, poderíamos adicionar uma nova linha com o comando
