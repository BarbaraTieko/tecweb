...
!!! tip "Dica"
    ...
    [ :simple-github: Github Classroom - Projeto 01](https://classroom.github.com/a/0phG7ZQC){:target="_blank"}
...
Após o final deste handout você terá um primeiro protótipo do Get-it, um sistema de bloco de notas.
