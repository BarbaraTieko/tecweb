...
!!! example "Exercício"
    Leia a [documentação do `#!python CharField`](https://docs.djangoproject.com/en/4.2/ref/models/fields/#charfield). Ele não é recomendável para textos grandes. Crie na classe `#!python Note` um atributo `#!python content` com o tipo apropriado.
