...
<figure markdown="span">
    ![Página Inicial Padrão](img/estrutura-de-pastas.png){ width="40%" }
</figure>
...
!!! question choice 
    Em nosso projeto, o que poderia ser definido como `app`?
    ...
    !!! details "Resposta"
        Nosso projeto Django foi definido como `getit` e o app definimos como `notes`, pois é a parte de nosso projeto responsável pelas funcionalidades relacionadas as anotações.
...
<figure markdown="span">
    ![](img/urlpatternv2.png){ width="100%" }
</figure>
