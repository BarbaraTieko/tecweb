...
- `manage.py`: programa com [diversos comandos](https://docs.djangoproject.com/en/4.1/ref/django-admin/#available-commands) que automatizam tarefas relacionadas ao seu projeto Django.
