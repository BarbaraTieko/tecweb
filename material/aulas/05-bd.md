...
Agora, utilize os comandos a seguir para criar o banco de dados e o usuário que serão utilizados pela sua aplicação (algumas configurações a seguir são recomendadas pela [documentação do Django](https://docs.djangoproject.com/en/5.0/ref/databases/#optimizing-postgresql-s-configuration){:target="_blank"}):
