# Deploy - Projeto 2 (Vercel)

Para o Deploy do Backend Django REST, não vamos utilizar o serviço do Heroku, pois não temos mais a opção gratuita.

Vocês tem a opção de fazer o deploy em qualquer plataforma de serviços que desejar. Existem várias opções gratuitas.
